...
const RecruiterLoginForm: React.FC<RecruiterLoginFormProps> = ({ onClose }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900">Recruiter Sign In</h2>
        <p className="mt-2 text-sm text-gray-600">
          Access your talent acquisition platform
        </p>
      </div>
