...
const ArchivedJobsPage: React.FC = () => {
  ...
  const [filters, setFilters] = useState<JobFilters>({
    page: 1,
    limit: 10,
    status: 'Closed', // Show only closed/archived jobs
    sortBy: 'updatedAt',
    sortOrder: 'DESC'
  });
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex items-center space-x-2">
          ...
          <span>Loading archived jobs...</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Error Loading Archived Jobs</h2>
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">View and manage closed job postings</p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search archived jobs by title..."
                value={searchTerm}
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">
            {pagination.total} Archived Jobs Found
          </h2>
        </div>
        ...
        {jobs.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No archived jobs found</h3>
            <p className="text-gray-600 mb-4">
              {searchTerm || filters.type || filters.department
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-6 text-sm text-gray-600 mb-3">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span>{job.applicantsCount || job.applicants || 0} total applicants</span>
                      </div>
                    </div>

                    <div className="flex items-center justify-between">
                      <div className="text-sm text-gray-600">
                        Closed on {formatDate(job.postedDate || job.updatedAt)}
                      </div>
