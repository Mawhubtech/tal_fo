        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              ...
              {sequence.name} - Enrollment Management
            </h1>
            <p className="text-gray-600 mt-1">
              Manage candidate enrollments and automation settings for {effectiveJob.title}
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-gray-600 text-sm">
                {sequence.type} • {sequence.category} • Enrollment Management
              </p>
            </div>
          </div>
...
export default SequenceEnrollmentPage;
