...
export const ROUTE_PERMISSIONS: Record<string, string[]> = {
  ...
  '/dashboard/search': [SIDEBAR_PERMISSIONS.SOURCING_ACCESS, SIDEBAR_PERMISSIONS.SEARCH_CANDIDATES],
  ...
  '/dashboard/sourcing/outreach/templates': [SIDEBAR_PERMISSIONS.SOURCING_ACCESS, SIDEBAR_PERMISSIONS.OUTREACH_TEMPLATES],
