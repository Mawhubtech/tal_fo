...
import { ClientEmailCampaigns } from './components';
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">{project.name} - Email Campaigns</h1>
            <p className="text-gray-600 mt-1">Manage email campaigns for this project</p>
          </div>
