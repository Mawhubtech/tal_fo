        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Link
                to={`/client-outreach/projects/${id}/edit`}
              ...
              <Link
                to={`/client-outreach/projects/${id}/settings`}
                className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
              >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Link
                  to={`/client-outreach/projects/${id}/searches`}
                ...
                <Link
                  to={`/client-outreach/projects/${id}/prospects`}
                  className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
                >
                ...
                <Link
                  to={`/client-outreach/projects/${id}/campaigns`}
                  className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
                >
                ...
                <Link
                  to={`/client-outreach/projects/${id}/analytics`}
                  className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
                >
